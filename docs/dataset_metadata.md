...
| key | value |
| --- | --- |
| dataset_title | A One-Year Context-Aware Synthetic IoT Dataset for Smart Waste Management in Dhaka, Bangladesh: 43.8 Million Hourly Observations |
| version | 4.0 |
| n_bins | 5000 |
| n_days | 365 |
| n_rows | 43800000 |
...
| archival_release_observation_format | Parquet |
...
| drive_csv_mirror | True; 44 compressed CSV/GZIP observation parts plus bins.csv.gz |
| csv_observation_parts | 44 |
| csv_partition_rows | parts 000-042: 1000000 each; part 043: 800000 |
| csv_total_rows | 43800000 |
...
| csv_validation_file | validate_csv_parts.py |
